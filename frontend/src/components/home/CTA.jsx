...
const CTA = () => {
  return (
    <section className="max-w-7xl mx-auto px-6 sm:px-8 pb-20 mt-40">
      <div className="bg-linear-to-br from-surface-container-high to-surface p-10 lg:p-20 relative overflow-hidden border border-outline-variant/10">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-on-surface-variant sm:text-lg">
